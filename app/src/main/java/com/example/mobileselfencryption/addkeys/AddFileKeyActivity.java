...
public class AddFileKeyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_file_key);
    ...
    public void cancelActivity(View view){
        Intent intent = new Intent(getApplicationContext(), AddFileKeyActivity.class);
        AddFileKeyActivity.this.finish();
    }
    ...
    private class AttemptAddKey extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... args) {
            String newFilesKey = args[0];
            String userId = args[1];
            ArrayList params = new ArrayList();
            params.add(new BasicNameValuePair("files_key", newFilesKey));
