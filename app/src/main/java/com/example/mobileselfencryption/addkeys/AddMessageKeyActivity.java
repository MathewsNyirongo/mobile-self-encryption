...
public class AddMessageKeyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_message_key);
    ...
    public void cancelActivity(View view){
        AddMessageKeyActivity.this.finish();
    }
    ...
    private class AttemptAddKey extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... args) {
            String newMessagesKey = args[0];
            String userId = args[1];
            ArrayList params = new ArrayList();
            params.add(new BasicNameValuePair("messages_key", newMessagesKey));
