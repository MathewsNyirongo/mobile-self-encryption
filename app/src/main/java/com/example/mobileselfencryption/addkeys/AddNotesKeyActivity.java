...
public class AddNotesKeyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_notes_key);
    ...
    public void cancelActivity(View view){
        Intent intent = new Intent(getApplicationContext(), AddNotesKeyActivity.class);
        AddNotesKeyActivity.this.finish();
    }
    ...
    private class AttemptAddKey extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... args) {
            String notesKey = args[0];
            String userId = args[1];
            ArrayList params = new ArrayList();
            params.add(new BasicNameValuePair("notes_key", notesKey));
